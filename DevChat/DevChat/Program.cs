using DevChat.Client.Pages;
using DevChat.Components;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        // HACK
        // This is due to wasm pages are rendered on server first,
        // So http client needs to be injected on both sides
